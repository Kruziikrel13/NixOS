{
  programs.hyprland.settings.windowrule = [
    ...
    "match:tag game, idle_inhibit always, immediate on, fullscreen on, float on, decorate off, keep_aspect_ratio on, render_unfocused on, no_vrr on"
    "match:tag video, content video, idle_inhibit always, fullscreen on, render_unfocused on, sync_fullscreen on, keep_aspect_ratio on"
